...
local WordList = {
    ...
    Hyphenated = loadstring(game:HttpGet("https://pastebin.com/raw/RPifGzzV", true))()
}
...
-- lib --
local Window = Library:New({Name = "WordBomb Helper [HYPHENATED WORDS TEST]", Accent = Color3.fromRGB(127, 127, 127)})
...
MainSection:Dropdown({Name = "WordList", Options = {"Normal","LongWords","Hyphenated"},Default = "Normal",Pointer = "WordListPointer"})
